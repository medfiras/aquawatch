"""Suez water provider stub for AquaWatch (not yet implemented)."""
...
_NOT_IMPLEMENTED_MSG = (
    "Suez n'est pas encore pris en charge. "
    "Contribuez sur https://github.com/medfiras/aquawatch pour l'ajouter."
)


@register_provider
class SuezProvider(WaterProvider):
    """Placeholder for a future Suez integration."""
